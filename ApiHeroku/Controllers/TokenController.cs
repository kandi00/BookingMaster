...
namespace ApiHeroku.Controllers
{
    ...
    public class TokenController : ControllerBase
    {
        ...
        private async Task<UserExample> GetUser(string email, string password)
        {
            return await _context.UserInfosExample.FirstOrDefaultAsync(u => u.Email == email && u.Password == password);
        }
    }
}
